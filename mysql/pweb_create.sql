...
create table personalidade (
    personalidade_id int not null auto_increment,
...
create table tipopersonalidade (
    tipopersonalidade_id int not null auto_increment,
...
create table favoritos (
    favoritos_id int not null auto_increment,
    fotografia_id int not null,
    utilizador_id int not null,
...
create table identificar (
    identificar_id int not null auto_increment,
    fotografia_id int not null,
...
create table albumfotos (
    albumfotos_id int not null auto_increment,
...
create table eventofotos (
    eventofotos_id int not null auto_increment,
...
create table eventolocalidade (
    eventolocalidade_id int not null auto_increment,
    evento_id int not null,
    localidade_id int not null,
