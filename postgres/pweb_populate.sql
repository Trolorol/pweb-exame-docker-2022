...
values
    ('heatbroccoli', '5Uj3YLC2cjvV', 'jpl@gmail.com', 1);
...
insert into
    utilizador (username, password, email, pessoa_id)
values
    ('cerealfruit', '6nxo1wfXfq', 'elsafi@sapo.pt', 10);
...
insert into
    fotografo (agencia, camara, pessoa_id)
values
    ('Facimus', 'Canon EOS 5D Mark IV PROFESSIONAL', 2);
...
insert into
    album (titulo, descricao, utilizador_id)
values
    ('Videoclips', 'Fotos de gravação de videoclips', 2);
